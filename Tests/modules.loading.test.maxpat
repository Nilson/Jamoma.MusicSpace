...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 554.0, 36.0, 142.0, 19.0 ],
					"text" : "jcom.position2musicspace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 554.0, 8.0, 142.0, 19.0 ],
					"text" : "jcom.musicspace2position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 325.0, 389.0, 19.0 ],
					"text" : "jcom.test.assert.equal.old \"TEST MusicSpace AllModulesLoadingProperly\" 0"
				}
...
, 			{
				"name" : "jcom.musicspace2position.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/JamomaUserLibraries/MusicSpace/components",
...
, 			{
				"name" : "jcom.position2musicspace.maxpat",
				"bootpath" : "/Users/nilspeters/Documents/gits/JamomaUserLibraries/MusicSpace/components",
				"patcherrelativepath" : "../components",
				"type" : "JSON",
				"implicit" : 1
